            ...
            <div class="col-md-4 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex flex-column align-items-center text-center p-3 ">
                        <img class="rounded mt-3 mb-2" width="250px" src="{{ asset('storage/' . $user->file_profil) }}">
                    </div>
                    <!-- Menghapus div dan button edit foto -->
                    <!-- <div onclick="modalAction('{{ url('/profile/' . session('user_id') . '/edit_foto') }}')"
                        class="mt-4 text-center"><button class="btn btn-primary profile-button" type="button"></button></div> -->
                </div>
            </div>
