        ...
        <div class="card-body">
            <form method="POST" action="{{ url('barang') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="number" class="form-control" id="barang_id" name="barang_id" value="{{ old('barang_id') }}" required>
                        @error('barang_id')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="number" class="form-control" id="kategori_id" name="kategori_id" value="{{ old('kategori_id') }}" required>
                        @error('kategori_id')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        <input type="number" class="form-control" id="barang_kode" name="barang_kode" value="{{ old('barang_kode') }}" required>
                        @error('barang_kode')
                            <small class="form-text text-danger">{{ $message }}</small>
                        @enderror
                    </div>
